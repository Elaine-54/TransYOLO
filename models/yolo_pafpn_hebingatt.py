...
class YOLOPAFPN(nn.Module):
    ...
    def __init__(
        ...
        self.Afpn1 = CFADdecoder(self.in_channels[1],8,0.1)
        self.Afpn2 = CFADdecoder(self.in_channels[0],8,0.1)
        self.Apan1 = CFADdecoder(self.in_channels[1],8,0.1)
        self.Apan2 = CFADdecoder(self.in_channels[2],8,0.1)
        self.kaiming_reset()
    ...
    def forward(self, input):
        ...
        f2 = self.lateral_conv1(f2)
        f2 = self.BN2(f2)
       
        afpn_out2 = self.Afpn2(x2,f2)
        ...
        apan_out1 = self.Apan1(afpn_out1,p1)
